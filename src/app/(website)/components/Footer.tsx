    ...
    <footer className="bg-blueBrand w-full text-white px-6 py-10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-10 md:gap-20">
        ...
        <div className="flex flex-col gap-2 text-center md:text-left">
          ...
          <a href="/homepage" className="hover:underline">3D</a>
          <a href="/homepage" className="hover:underline">Graphic</a>
          <a href="/homepage" className="hover:underline">Product Design</a>
          <a href="/homepage" className="hover:underline">Editor & Motion</a>
          <a href="/homepage" className="hover:underline">Digital Art</a>
          <a href="/homepage" className="hover:underline">Game Design</a>
        </div>
      </div>
    </footer>
  );
